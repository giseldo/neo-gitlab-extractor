...
url_original = "https://gitlab.com/api/v4/projects/gitlab-org%2Fgitlab/issues?id=gitlab-org%2Fgitlab&order_by=created_at&page=199&per_page=100&sort=desc&state=closed&weight=Any&with_labels_details=false" # 19.764 / 100 = 197,64
project_name = "gitlab"
...
def main():
    ...
    get_page(project_name, url_original, 198)

    next_url = url_original
    
    for x in range(199, int(201)):
